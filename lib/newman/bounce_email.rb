...
#   https://github.com/mitio/bounce_email/blob/master/lib/bounce_email.rb
# under the MIT License
#
# As the bounce_email gem is a bit in flux, and it may get incorporated into 
# the Mail gem itself, and it's only a single file with no dependencies besides
# Mail, I thought it best to just copy the source file into Newman directly for
# now.
